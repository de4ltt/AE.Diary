...
sealed class DiaryUIEvent {
    ...
    data class SetDaySubjectStudentAbsent(
        val student: Student,
        val daySubject: Subject,
        val date: String = ""
    ) : DiaryUIEvent()

    data class SetDaySubjectStudentPresent(
        val student: Student,
        val daySubject: Subject,
        val date: String = ""
    ) : DiaryUIEvent()

    data class SetDaySubjectStudentAbsentRespectful(
        val student: Student,
        val daySubject: Subject,
        val date: String
    ) : DiaryUIEvent()

    data class SetDaySubjectStudentPresentRespectful(
        val student: Student,
        val daySubject: Subject,
        val date: String
    ) : DiaryUIEvent()
