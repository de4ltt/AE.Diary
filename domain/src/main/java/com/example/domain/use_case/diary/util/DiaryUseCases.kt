package com.example.ae_diary.domain.use_case.diary.util

import com.example.ae_diary.domain.use_case.diary.AddStudentAbsenceUseCase
import com.example.ae_diary.domain.use_case.diary.DeleteStudentAbsenceUseCase
import com.example.ae_diary.domain.use_case.diary.DismissSubjectUseCase
import com.example.ae_diary.domain.use_case.diary.GetAllAbsenceUseCase
import com.example.ae_diary.domain.use_case.diary.UndismissSubjectUseCase
